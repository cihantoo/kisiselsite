    ...
    return (
        <div align="center">
            ...
            <div className="flex flex-col sm:flex-row max-w-8xl justify-between items-center py-8 w-11/12 sm:w-10/12 mx-auto">
                <h1 className="font-sans text-white text-2xl font-semibold flex gap-2 items-end">cihan<span className="text-primary">too</span>
                <div className="bg-primary-100 text-sm px-2 py-2 font-sans text-gray-400 rounded-lg">v30(plus)one 🤠</div></h1>
